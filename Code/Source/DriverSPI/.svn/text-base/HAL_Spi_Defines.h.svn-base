#ifndef _HAL_SPI_DEFINES_H_
#define _HAL_SPI_DEFINES_H_  (1)
...
#define DRIVER_MAJOR            (243)
#define DRIVER_NAME             "SpiDriver"
...
/* This is general/Normal debug messages to print variable values or info*/
#if DEBUG
