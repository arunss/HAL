#ifndef _HAL_I2C_DEFINES_H_
#define _HAL_I2C_DEFINES_H_       (1)
/*
 *  GPL LICENSE SUMMARY
 *
...
/*-----------------------------------------------------------------------------
* PURPOSE
*    This header file contains debug macros "define" used in DOCSIS I2C Driver
*
*----------------------------------------------------------------------------*/
