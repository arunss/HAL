#ifndef _HAL_US_DEFINES_H_
#define _HAL_US_DEFINES_H_ (1)
...
/*-----------------------------------------------------------------------------
* PURPOSE
*      This header file contains debug macros "define" used in DriverUs
*
*----------------------------------------------------------------------------*/
